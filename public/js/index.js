...
var colorPicker = (function() {
  var colors = ["#0b2d41", "#ff3434", "#2980B9", "#630964"];
  var index = 0;
  function next() {
...
function addClickListeners() {
  document.getElementById('SearchButton').addEventListener("touchstart", handleEvent);
  document.getElementById('SearchButton').addEventListener("mousedown", handleEvent);
};
...
function SearchNearbyPlace(){
    ...
    $.get(searchUrl, function(data){
        if(data.success){
            ...
            $('#NearbyListShortMessage').text(`${data.nearbyList.length} records were found.`)
            $('.NearbyListModal').modal('toggle');
        }else{
